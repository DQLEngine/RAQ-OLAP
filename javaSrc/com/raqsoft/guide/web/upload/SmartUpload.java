package com.raqsoft.guide.web.upload;
...
public class SmartUpload
{
	...
	public final void initialize( ServletContext application, HttpSession session, HttpServletRequest request,
								  HttpServletResponse response, JspWriter out ) throws ServletException
	{
	...
	public void upload() throws SmartUploadException, IOException, ServletException
	{
		...
		for ( ; totalRead < m_totalBytes; totalRead += readBytes )
		{
			...
			{
				//com.runqian.base4.util.Logger.debug( e.getMessage(), e );
		...
		do
		{
			...
			if ( isFile && fileName.length() > 0 )
			{
				...
				{
					throw new SecurityException( String.valueOf( ( new StringBuffer( "Size exceeded for this file : " ) ).
						append( fileName ).append( " (1105)." ) ) );
				}
			...
			if ( isFile )
			{
				com.raqsoft.guide.web.upload.File newFile = new com.raqsoft.guide.web.upload.File();
	...
	public void downloadFile( String sourceFilePathName, String contentType,
							  String destFileName ) throws SmartUploadException, IOException, ServletException
	{
		downloadFile( sourceFilePathName, contentType, destFileName, 65000 );
	}

	public void downloadFile( String sourceFilePathName, String contentType, String destFileName,
							  int blockSize ) throws SmartUploadException, IOException, ServletException
	{
		...
		if ( destFileName == null )
		{
			m_response.setHeader( "Content-Disposition",
								  String.valueOf( ( new StringBuffer( String.valueOf( m_contentDisposition ) ) ).append(
				" filename=" ).append( getFileName( sourceFilePathName ) ) ) );
		}
	...
	public void downloadField( ResultSet rs, String columnName, String contentType,
							   String destFileName ) throws SQLException, IOException, ServletException
	{
		if ( rs == null )
		{
	...
	public void fieldToFile( ResultSet rs, String columnName, String destFilePathName ) throws SQLException,
	...
	protected String getPhysicalPath( String filePathName, int option ) throws IOException
	{
		...
		if ( option == 0 )
		{
			if ( isVirtual( path ) )
			{
				...
				{
					path =
						String.valueOf( ( new StringBuffer( String.valueOf( path ) ) ).append( fileSeparator ).append(
						fileName ) );
				}
				return path;
			}
