 ...
 *
 */
public class AnalyseTag extends TagSupport {
	private String view;
	private String olap;
...
//			out.println("guideConf.fileHome = '"+fileHome+"';");
			...
			if(!resetLmdFlag) out.println("guideConf.isQuery = '1';");
			...
			pageContext.include(guideDir+"jsp/template_c.jsp?jsv=new&guideDir="+URLEncoder.encode(guideDir, "UTF-8")+"&title="+URLEncoder.encode(title, "UTF-8"),true);
